...
;;
;; Copyright (c) Passions Play
;;
;; Author: Benjamin Turner <benjamin@passionsplay>
;;     Basically taken from here:
;;     https://github.com/choppsv1/dot.spacemacs.d/tree/master/layers/org2blog
;;
    ...
    (progn
      ...
      (if org2blog-name
        (setq org2blog/wp-blog-alist
          `((,org2blog-name
              :url ,(concat "https://" org2blog-name "/xmlrpc.php")
